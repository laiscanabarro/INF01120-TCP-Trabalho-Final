...
public class ProductivityPage extends Page {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(804, 474));
        ...
        gridBagConstraints.insets = new java.awt.Insets(15, 6, 6, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(6, 58, 0, 106);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        LoginPage.currentUser.getProductivity().decreaseGoal();
        jLabel3.setText("GOAL: " + LoginPage.currentUser.getProductivity().getGoal());
        jLabel4.setText("PROGRESS: " + LoginPage.currentUser.getProductivity().getProgress());
    }
