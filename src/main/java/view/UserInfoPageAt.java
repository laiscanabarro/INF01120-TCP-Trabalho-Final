 ...
 * @author i576263
 */
public class UserInfoPageAt extends Page {

    /**
     * Creates new form UserInfoPageAt
     */
    public UserInfoPageAt() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserInfoPageAt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserInfoPageAt().setVisible(true);
            }
        });
    }
