...
public class TasksUtils {
    ...
    public static final String ORDER_END_DATE_ASC = "dateAsc";
    public static final String ORDER_END_DATE_DESC = "dateDesc";
    public static final Locale LOCALE = new Locale("pt_BR");
